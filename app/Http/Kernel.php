...
class Kernel extends HttpKernel
{
     ...
     *
     * This determines the order the middleware is executed in.
     *
     * @var array
     */
    protected $middlewarePriority = [
        ...
        \Illuminate\Translation\Middleware\SetLocale::class,
        \Illuminate\Translation\Middleware\HandleFallbackLocale::class,
