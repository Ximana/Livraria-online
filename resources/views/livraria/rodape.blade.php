			...
			<div class="row">
				<div class="col-md-4 pt-5">
					...
					<ul class="list-unstyled text-light footer-link-list">
						<li>
							<i class="fas fa-map-marker-alt fa-fw"></i> Luanda Maianga
							Cassequel
						</li>
						<li>
				...
				<div class="col-md-4 pt-5">
					...
					<ul class="list-unstyled text-light footer-link-list">
						<li>
							<a class="text-decoration-none" href="#">Ciência</a>
						</li>
						<li><a class="text-decoration-none" href="#">Descporto</a></li>
						<li>
							<a class="text-decoration-none" href="#">Matemática</a>
						</li>
						<li><a class="text-decoration-none" href="#">Romance</a></li>
						<li>
							<a class="text-decoration-none" href="#">Computação</a>
						</li>
					</ul>
				</div>
				...
				<div class="col-md-4 pt-5">
					...
					<ul class="list-unstyled text-light footer-link-list">
						...
						<li><a class="text-decoration-none" href="{{ route('sobre') }}">Sobre Nós</a></li>
						<li><a class="text-decoration-none" href="#">Localização</a></li>
						<li><a class="text-decoration-none" href="#">Perguntas</a></li>
						<li><a class="text-decoration-none" href="{{ route('contato') }}">Contacto</a></li>
					</ul>
				</div>
			</div>
